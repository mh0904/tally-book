        ...
        <section className="transaction-ledger page-panel">
            ...
            {monthGroups.length ? (
              monthGroups.map((group) => (
                <button
                  ...
                  onClick={() => {
                    searchForm.resetFields();
                    setSearchParams({ month: group.monthKey });
                  }}
                  type="button"
                >
          ...
          <section className="ledger-records">
            <div className="ledger-header">
              <div>
                <strong>流水列表</strong>
                <span>结余 {formatAmount(viewSummary.balance)}</span>
                <span className="income">收入 {formatAmount(viewSummary.income)}</span>
                <span className="expense">
                  支出 {formatAmount(viewSummary.expense)}
                </span>
              </div>
              <span>{desktopTransactions.length} 笔</span>
            </div>
